# <p align='center'> C. Assembly via Minimums </p>
<p align='center'> time limit per test: 2 seconds </p>
<p align='center'> memory limit per test: 256 megabytes </p>

Sasha has an array $a$ of $n$ integers. He got bored and for all $i, j$ ($i < j$), he wrote down the minimum value of $a_i$ and $a_j$. He obtained a new array $b$ of size $\frac{n(n-1)}{2}$.  
...
The second line of each test case contains $\frac{n(n-1)}{2}$ integers $b_1, b_2, \dots, b_{\frac{n(n-1)}{2}}$ ($-10^9 \le b_i \le 10^9$) — the elements of array $b$.  
